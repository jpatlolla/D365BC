    ...
    layout
    {
        addafter(Item)
        {
            group(eShop)
            {
                ...
                field("eShop Manufacturer Code"; "Manufacturer Code")
                {
                    Caption = 'eShop Manufacturer Code';
                    ApplicationArea = ALL;
                }
        ...
        addafter("S&ales")
        {
            group("eShop Process")
            {
                ...
                action("eShop Item Variantions")
                {
                    ...
                    Image = ItemVariant;
                    PromotedCategory = Category6;
                    RunObject = page "eShop Variations";
        ...
        area(content)
        {
            ...
            group("E - Commerce")
            {
                ...
                group(BizTalk)
                {
                    ...
                    field("Additional Shipping Charge"; "eShop Add Shipping Charge")
                    {
                        ApplicationArea = All;
                    }
...
/*page 70009752 "eshop Record Links"
{
